...
use bonanca_api_lib::{Asset, Oracle, get_oracle};
use bonanca_core::{config::Config, get_default_config};
use bonanca_db::BonancaDB;
use bonanca_swap::exchange::{Exchange, get_exchange};
use bonanca_wallets::{Wallet, get_wallet, get_wallet_view};
...
impl IndexFund {
    ...
    fn get_rpc_url(&self) -> Result<String> {
        match &self.rpc_url {
            ...
            None => {
                let db = BonancaDB::new(self.config.database.clone());
