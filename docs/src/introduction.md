...
Bonança is fully free and completely open source. You can find the source code on [GitHub](https://github.com/Cavenfish/bonanca). The crypto is yours, and you are in full control of your funds at all times.
...
To get started with Bonança, follow the instructions in the [Installation](./install.md) guide. Once installed, you can create a wallet by following the steps in the [Create Account](./create.md) section. After setting up your wallet, you can manage your index fund using the instructions provided in the [Manage Index Fund](./manage_index.md) documentation.
